...
Return a tibble with the 10 Instagram posts by `corona` (this time it's the beer!).


```{r, eval = F}

corona_beer <- insta_posts(query = "corona", 
                         scope = "username",
                         max_posts = 10, 
                         scrape_comments = F)
...
corona_beer_comments <- insta_posts(query = "corona", 
                         scope = "username",
                         max_posts = 10, 
                         scrape_comments = T)


corona_beer_comments
```

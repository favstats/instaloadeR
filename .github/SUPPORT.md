# Getting help with instaloadeR

Thanks for using instaloadeR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/instaloadeR/issues) to make sure the 
